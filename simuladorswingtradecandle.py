# -*- coding: utf-8 -*-
"""SimuladorSwingtradeCandle

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1k7KZKGZitDTJJRco7lwwH2zdBrlvY-Ej
"""
...
for i in range(len(Fechamento)):
  ...
  # Depurar
  #print(i,Fechamento[i],SARParabolic[i],Tendencia,AtingiuLimiar)
####################################################
...
#
# Atraso
#Amu = 2.4544390408833956
#Asigma = 0.5268861610675303
#
...
axs4 = fig.add_subplot(spec[3,0])
axs5 = fig.add_subplot(spec[3,1])
axs6 = fig.add_subplot(spec[4,0])
axs7 = fig.add_subplot(spec[4,1])
#
